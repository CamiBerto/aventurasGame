...
object nivelBloques {
	var property vidaVisual = new Vida()
	var property granadaVisual = new Granada()
	var property energiaVisual = new Energia()
	method configurate() {
		...
		granadaVisual.iniciarGrafico("gran.png","adas.png")
	...
	method terminar() {
		...
		game.schedule(2500, { game.clear()
			...
			game.schedule(3000, { // ... limpio todo de nuevo
				...
				personajeSimple.nivelActual(nivelLlaves)
